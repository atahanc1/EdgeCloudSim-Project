...
package edu.boun.edgecloudsim.applications.sample_app9;
...
public class MainApp {
	...
	public static void main(String[] args) {
		...
		if (args.length == 5){
			...
			configFile = "scripts/sample_app9/config/default_config.properties";
			applicationsFile = "scripts/sample_app9/config/applications.xml";
			edgeDevicesFile = "scripts/sample_app9/config/edge_devices.xml";
			outputFolder = "sim_results/sample_app9/ite" + iterationNumber;
		}
